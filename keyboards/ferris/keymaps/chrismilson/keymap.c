...
enum layers {
    ...
    _QWERTY,
    // Optional base layer for more better typing happy time
    _COLEMAK,
    // Special characters
    _SPECIAL,
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   // The layer is here because I believe, but there is no way to toggle it, because I don't believe.
   // If we were to toggle it, it should probably be done with DF(_COLEMAK) (or _QWERTY should be removed...)
   [_COLEMAK] = LAYOUT(
       KC_Q,    KC_W,    KC_F,    KC_P,    KC_B,      KC_J,    KC_L,    KC_U,    KC_Y,    KC_SCLN,
       KC_A,    KC_R,    KC_S,    KC_T,    KC_G,      KC_M,    KC_N,    KC_E,    KC_I,    KC_O,
       GUI_Z,   ALT_X,   KC_C,    KC_D,    KC_V,      KC_K,    KC_H,    KC_COMM, ALT_DOT, GUI_SLS,
              LCTL_T(KC_ENT), LT(_SPECIAL, KC_SPC),    LT(_NUMBERS, KC_BSPC), KC_LSFT
   ),
    ...
    [_SPECIAL] = LAYOUT_SUPER(
        ...
        KC_DEL,  KC_PIPE, KC_PLUS, KC_UNDS, KC_DQUO,   KC_LPRN, KC_RPRN, KC_LBRC, KC_RBRC, KC_DEL,
                                   _______, _______,   _______, _______
    ),

    [_NUMBERS] = LAYOUT_SUPER(
        _______, KC_MSTP, KC_MPRV, KC_MNXT, XXXXXXX,   KC_UNDS, KC_7,    KC_8,    KC_9,    _______,
        _______, KC_VOLD, KC_VOLU, KC_MPLY, XXXXXXX,   KC_SPC,  KC_4,    KC_5,    KC_6,    _______,
        XXXXXXX, KC_BRID, KC_BRIU, KC_MUTE, XXXXXXX,   KC_0,    KC_1,    KC_2,    KC_3,    OS_NUMX,
                                   _______, _______,   _______, _______
    ),
    ...
    [_NUMBERS_AUX] = LAYOUT_SUPER(
        ...
        XXXXXXX, KC_F1,   KC_F2,   KC_F3,   KC_F10,    KC_COLN, KC_MINS, KC_SLSH, KC_COMM, KC_NO,
                                   _______, _______,   _______, _______
    ),

    [_ARROWS] = LAYOUT_SUPER(
        _______, KC_WH_D, KC_MS_U, KC_WH_U, QK_RBT,    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, _______,
        _______, KC_MS_L, KC_MS_D, KC_MS_R, XXXXXXX,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, _______,
        KC_BTN1, KC_BTN2, XXXXXXX, XXXXXXX, EP_HOME,   XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
                                   _______, _______,   _______, _______
    ),

    [_EPHEMERAL_HOME] = LAYOUT(
        TO(_SUDOKU), TO(_WASD), TO(_WASD_ARROWS), XXXXXXX,        XXXXXXX,
